...
class App extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(Contacts, { contacts: this.props.contactList.contacts, setContact: this.props.selectContact }),
            React.createElement(ContactDetails, { contact: this.props.contact })
        );
    }
}
...
class ContactItem extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            'div',
            { id: "contact-" + this.props.id, onClick: this.props.selectContact },
            React.createElement('img', { src: contactPicture }),
            React.createElement(
                'div',
                { className: 'details' },
                React.createElement(
    ...
    render() {
        ...
        return React.createElement(
            ...
            this.props.contacts.map(item => {
                contactKey++;
                return React.createElement(ContactItem, _extends({ key: contactKey, selectContact: this.props.setContact }, item));
            })
        );
    }
}
...
function setState(changes) {
    ...
    ReactDOM.render(React.createElement(App, state), document.body);
}
...
const contacts = [{
    ...
    "gender": "male",
    "name": { "title": "mr", "first": "arthur", "last": "cote" },
    ...
    "gender": "female",
    "name": { "title": "miss", "first": "olivia", "last": "cote" },
    ...
    "gender": "female",
    "name": { "title": "ms", "first": "clara", "last": "cote" },
    "location": {
    ...
    "gender": "female",
    "name": { "title": "mrs", "first": "amelia", "last": "cote" },
    "location": { "street": "1744 dufferin st", "city": "chelsea", "state": "quebec", "postcode": 39648 },
    "email": "amelia.cote@example.com",
...
/* harmony export (immutable) */ __webpack_exports__["contacts"] = contacts;
